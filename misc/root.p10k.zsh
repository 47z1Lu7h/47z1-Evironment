# Generated by Powerlevel10k configuration wizard on 2022-05-03 at 02:05 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    #kubecontext             # current kubernetesicontext (https://kubernetes.io/)
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='   壟'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='  '
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='  壟'
